...
public class Draft implements Serializable {
    ...
    @ApiModelProperty(value = "图文消息的封面图片素材id（一定是永久MediaID）")
    private String thumb_media_id;

    @ApiModelProperty(value = "是否显示封面，0为false，即不显示，1为true，即显示")
    private Integer show_cover_pic;

    @ApiModelProperty(value = "Uint32 是否打开评论，0不打开(默认)，1打开")
    private Integer need_open_comment;

    @ApiModelProperty(value = "Uint32 是否粉丝才可评论，0所有人可评论(默认)，1粉丝才可评论")
    private Integer only_fans_can_comment;

    @ApiModelProperty(value = "草稿的临时链接")
    private String url;
